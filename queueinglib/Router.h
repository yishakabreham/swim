...
class QUEUEING_API Router : public cSimpleModule
{
    private:
        ...
        int sumWeight;
        string serverWeight;   //server weight in string
    protected:
        virtual void initialize() override;
        virtual void handleMessage(cMessage *msg) override;
        virtual vector<int> getActiveCapacities(string weightString, int serverNumber);
        virtual int getWeightedServerIndex(int index, int jobno, vector<int> activeCapacities);
};
